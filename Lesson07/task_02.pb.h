...
#ifndef GOOGLE_PROTOBUF_INCLUDED_task_5f02_2eproto
#define GOOGLE_PROTOBUF_INCLUDED_task_5f02_2eproto
...
#include <google/protobuf/port_def.inc>
#define PROTOBUF_INTERNAL_EXPORT_task_5f02_2eproto
...
struct TableStruct_task_5f02_2eproto {
  static const uint32_t offsets[];
};
extern const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_task_5f02_2eproto;
class FullName;
...
class FullName final :
 ...
 private:
  ...
  union { Impl_ _impl_; };
  friend struct ::TableStruct_task_5f02_2eproto;
};
// -------------------------------------------------------------------
...
class Student final :
 ...
 public:
  ...
  public:
  void clear_name();
  const ::FullName& name() const;
  PROTOBUF_NODISCARD ::FullName* release_name();
  ::FullName* mutable_name();
  void set_allocated_name(::FullName* name);
  private:
  const ::FullName& _internal_name() const;
  ::FullName* _internal_mutable_name();
  public:
  void unsafe_arena_set_allocated_name(
      ::FullName* name);
  ::FullName* unsafe_arena_release_name();
...
inline const ::FullName& Student::_internal_name() const {
  const ::FullName* p = _impl_.name_;
  return p != nullptr ? *p : reinterpret_cast<const ::FullName&>(
      ::_FullName_default_instance_);
}
inline const ::FullName& Student::name() const {
...
inline ::FullName* Student::release_name() {
  
  ::FullName* temp = _impl_.name_;
  _impl_.name_ = nullptr;
...
inline ::FullName* Student::unsafe_arena_release_name() {
...
inline ::FullName* Student::_internal_mutable_name() {
...
inline ::FullName* Student::mutable_name() {
  ::FullName* _msg = _internal_mutable_name();
  // @@protoc_insertion_point(field_mutable:Student.name)
  return _msg;
}
inline void Student::set_allocated_name(::FullName* name) {
...
inline uint32_t Student::avg_score() const {
  // @@protoc_insertion_point(field_get:Student.avg_score)
...
inline void Student::set_avg_score(uint32_t value) {
  ...
  // @@protoc_insertion_point(field_set:Student.avg_score)
}
...
#include <google/protobuf/port_undef.inc>
#endif  // GOOGLE_PROTOBUF_INCLUDED_GOOGLE_PROTOBUF_INCLUDED_task_5f02_2eproto
